...
export const TRANSLATIONS = {
  en: {
    ...
    IMPORT_HEADER: "IMPORT DLC",
    EXPORT_HEADER: "EXPORT DLC",
    PASTE_JSON: "Paste JSON code here...",
    LOAD_FROM_TEXT: "LOAD FROM TEXT",
    LOAD_FROM_FILE: "LOAD FROM FILE",
    IMPORT_SUCCESS: "DLC Imported Successfully!",
    IMPORT_ERROR: "Error importing DLC. Check JSON format.",
    LOAD_TO_EDIT: "Load to Edit",
    TEST_PLAY: "TEST PLAY",
    ADD_TO_DLC: "ADD / UPDATE DLC",
  ...
  zh: {
    ...
    EXPORT: "导出",
    IMPORT_EXPORT: "导入 / 导出",
    IMPORT_HEADER: "导入 DLC",
    EXPORT_HEADER: "导出 DLC",
    PASTE_JSON: "在此粘贴 JSON 代码...",
    LOAD_FROM_TEXT: "从文本加载",
    LOAD_FROM_FILE: "从文件加载",
    IMPORT_SUCCESS: "DLC 导入成功！",
    IMPORT_ERROR: "导入失败。请检查 JSON 格式。",
    LOAD_TO_EDIT: "加载编辑",
    TEST_PLAY: "测试游玩",
    ADD_TO_DLC: "添加 / 更新到 DLC",
    ADDED_PLANTS: "已添加植物",
    ADDED_ZOMBIES: "已添加僵尸",
    WAVES: "波次",
    EVENTS: "事件",
