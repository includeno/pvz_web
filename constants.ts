...
export const INITIAL_PLANT_STATS: Record<string, PlantConfig> = {
  [BasePlantType.SUNFLOWER]: { 
      type: BasePlantType.SUNFLOWER, name: 'Sunflower', cost: 50, cooldown: 5000, health: 300, icon: '🌻', description: 'Produces sun',
  ...
  [BasePlantType.WALLNUT]: { 
      type: BasePlantType.WALLNUT, name: 'Wall-nut', cost: 50, cooldown: 20000, health: 4000, icon: '🥔', description: 'Blocks zombies',
      visuals: createVisuals(ART_WALLNUT, undefined, 1),
      abilities: [ { type: 'WALL' } ]
  },
  [BasePlantType.SQUASH]: { 
      type: BasePlantType.SQUASH, name: 'Squash', cost: 50, cooldown: 30000, health: 10000, icon: '😠', description: 'Stomps zombies',
  ...
  [BasePlantType.CHERRY_BOMB]: {
      type: BasePlantType.CHERRY_BOMB, name: 'Cherry Bomb', cost: 150, cooldown: 20000, health: 300, icon: '🍒', description: 'Explodes nearby zombies',
  ...
  [BasePlantType.POTATO_MINE]: {
      type: BasePlantType.POTATO_MINE, name: 'Potato Mine', cost: 25, cooldown: 30000, health: 300, icon: '🥔', description: 'Explodes on contact',
  ...
  [BasePlantType.CHOMPER]: {
      type: BasePlantType.CHOMPER, name: 'Chomper', cost: 150, cooldown: 5000, health: 300, icon: '🦷', description: 'Eats zombies whole',
  ...
  [BasePlantType.SUN_SHROOM]: {
      type: BasePlantType.SUN_SHROOM, name: 'Sun Shroom', cost: 25, cooldown: 5000, health: 100, icon: '🍄', description: 'Gives small sun then big',
  ...
  [BasePlantType.HYPNO_SHROOM]: {
      type: BasePlantType.HYPNO_SHROOM, name: 'Hypno Shroom', cost: 75, cooldown: 5000, health: 100, icon: '🌀', description: 'Hypnotizes zombies',
  ...
  [BasePlantType.DOOM_SHROOM]: {
      type: BasePlantType.DOOM_SHROOM, name: 'Doom Shroom', cost: 125, cooldown: 50000, health: 100, icon: '💣', description: 'Massive explosion',
  ...
  [BasePlantType.TORCHWOOD]: {
      type: BasePlantType.TORCHWOOD, name: 'Torchwood', cost: 175, cooldown: 5000, health: 300, icon: '🔥', description: 'Ignites peas',
      visuals: createVisuals(ART_TORCHWOOD, undefined, 4),
      abilities: [ { type: 'WALL' } ]
  },
  [BasePlantType.TALLNUT]: {
      type: BasePlantType.TALLNUT, name: 'Tall-nut', cost: 125, cooldown: 20000, health: 8000, icon: '🧱', description: 'Blocks vaulting zombies',
...
export const INITIAL_ZOMBIE_STATS: Record<string, ZombieStatConfig> = {
  ...
  [BaseZombieType.POLE_VAULTING]: {
      health: 500, speed: 0.12, damage: 1, icon: '🏃',
  ...
  [BaseZombieType.DANCING]: {
      health: 500, speed: 0.04, damage: 1, icon: '🕺',
...
export const CONSUMABLES: Record<ConsumableType, { name: string, icon: string, cost: number, description: string }> = {
    [ConsumableType.SUN_PACK]: { name: 'Sun Crate', icon: '☀️', cost: 1000, description: 'Instantly gives 500 Sun.' },
    [ConsumableType.REPAIR_KIT]: { name: 'Repair Kit', icon: '🔧', cost: 500, description: 'Fully heals all plants.' },
    [ConsumableType.TACTICAL_NUKE]: { name: 'Doom Nuke', icon: '☢️', cost: 2500, description: 'Kills all zombies on screen.' },
    [ConsumableType.TIME_FREEZE]: { name: 'Stopwatch', icon: '⏱️', cost: 1500, description: 'Freezes zombies for 10 seconds.' }
};
